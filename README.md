...
遵循 GHG Protocol 的企业级碳排放计量平台，支持 Scope 1/2/3 全范围碳核算。
...
### 💼 业务功能
- **完整碳核算** - 支持 Scope 1/2/3 全范围排放计量
- **多租户架构** - 组织级隔离，支持成员权限管理 (RBAC)
- **灵活计量引擎** - 可扩展的计量器框架，支持自定义排放因子
- **数据质量管理** - 支持测量、计量、估算三级数据质量标识
- **批量数据处理** - CSV/Excel 导入导出，批量计量功能
...
- 🧮 **专业计量引擎**：严格遵循 GHG Protocol 标准的计量算法
